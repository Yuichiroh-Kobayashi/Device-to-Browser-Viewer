...
Current post-beta.1 Viewer source also adds system-aware Light/Dark presentation, a page-lifetime manual Light/Dark override, and CUD-informed / WCAG 2.2-targeted semantic colour tokens. That work is presentation-only and is recorded in [`theme-and-color-contract.md`](theme-and-color-contract.md). It does not change beta.1, its accepted bundle identity, or any measurement, D2B or WebSocket behaviour.
